        ...
        try:
            with zipfile.ZipFile(filepath, 'r') as zip_file:
                ...
                for content_file in content_files:
                    ...
                    except (UnicodeDecodeError, zipfile.BadZipFile, KeyError) as e:
                        logger.warning(f"Failed to read content file {content_file}: {e}")
                        continue
                    except Exception as e:
                        logger.error(f"Unexpected error reading {content_file}: {e}")
                        continue
